...
public abstract class AbstractPingSender implements Flushable {
    ...
    synchronized PingResponse sendPing(InetAddress host, int port) throws IOException {
    ...
    private synchronized PingResponse sendPing(InetAddress host, int port, InputStream in, OutputStream out) throws IOException {
        setFlushable(out);
        try {
    ...
    private void setFlushable(Flushable flushable) {
    ...
    String readLegacyString(DataInput in) throws IOException {
    ...
    void writeLegacyString(DataOutput out, String s) throws IOException {
